...
- **Other**: Redis, RabbitMQ, Kafka, Lombok, Springdoc (Swagger/OpenAPI)
...
- **Entity & DTO**: 엔티티 클래스는 비즈니스 로직과 데이터 보존에만 집중하며, 외부 노출 시에는 반드시 별도의 DTO(Data Transfer Object)를 사용하고 `Record` 타입을 적극 활용
